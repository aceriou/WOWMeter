# inactive project
This project was abandoned, but the code will remain for whoever wants to start their own clickme site. Please don't host an exact replica of WOWMeter though, this serves as a base.
